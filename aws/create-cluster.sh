...
if [ "$SUBNET1_PUBLIC_ID" = "None" ] || [ -z "$SUBNET1_PUBLIC_ID" ]; then
...
if [ "$SUBNET2_PUBLIC_ID" = "None" ] || [ -z "$SUBNET2_PUBLIC_ID" ]; then
...
if [ "$SUBNET1_PRIVATE_ID" = "None" ] || [ -z "$SUBNET1_PRIVATE_ID" ]; then
...
if [ "$SUBNET2_PRIVATE_ID" = "None" ] || [ -z "$SUBNET2_PRIVATE_ID" ]; then
...
echo "EKS Cluster creation initiated. It may take a few minutes for the cluster to be fully operational."
